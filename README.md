...
This code essentially takes the HDF files covering California for a day (3 seperate files determined by date on image name) and creates a TIFF image of the 3 files in the same frame.
